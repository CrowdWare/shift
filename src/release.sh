...
mv /Users/art/SourceCode/Shift/src/build-project/build/outputs/apk/release/build-project-release-aligned-debugSigned.apk /Users/art/SourceCode/Shift/src/build-project/build/outputs/apk/release/shift-1.0.1-signed.apk