...
cp /Users/art/SourceCode/Shift/src/build-project/build/outputs/apk/release/build-project-release-aligned-debugSigned.apk /Users/art/SourceCode/Shift/web/content/shift-1.0.0-signed.apk